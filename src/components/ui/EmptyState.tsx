...
function FeedIllustration() {
  ...
  return (
    <View style={illustrationStyles.container}>
      ...
      <Animated.View entering={FadeInDown.delay(50).springify().damping(15)} style={[illustrationStyles.backCard, { backgroundColor: colors.accentSoft }]} />
      <Animated.View entering={FadeInDown.delay(100).springify().damping(15)} style={[illustrationStyles.midCard, { backgroundColor: colors.primarySoft }]} />
      <Animated.View entering={FadeInDown.delay(100).springify().damping(15)} style={[illustrationStyles.frontCard, { backgroundColor: colors.background, borderColor: colors.border }]}>
...
function FavoritesIllustration() {
  ...
  return (
    <View style={illustrationStyles.container}>
      <Animated.View entering={FadeInUp.delay(50).springify().damping(15)}>
...
export default function EmptyState({ variant = 'generic', title, subtitle, actionLabel, onAction }: EmptyStateProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.Text
        entering={FadeInDown.delay(280).springify().damping(15)}
        style={[styles.subtitle, { color: colors.textSecondary }]}
      >
        {subtitle}
      </Animated.Text>
      {actionLabel && onAction && (
        <Animated.View entering={FadeInUp.delay(360).springify().damping(15)}>
          <TouchableOpacity
